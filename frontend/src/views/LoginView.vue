...
<template>
  <section class="mx-auto max-w-md">
    <div class="mb-6 flex flex-col gap-2 text-center">
      <span class="eyebrow text-brand-600">Bon retour</span>
      <h1 class="text-3xl font-bold tracking-tight text-stone-900">Connexion</h1>
    </div>
    ...
    <BaseCard>
      <form class="flex flex-col gap-4" @submit.prevent="handleSubmit">
        ...
        <p class="text-center text-sm text-stone-500">
          Pas de compte ?
          <RouterLink to="/register" class="font-medium text-brand-600 hover:text-brand-700">Inscrivez-vous</RouterLink>
        </p>
      </form>
    </BaseCard>
  </section>
